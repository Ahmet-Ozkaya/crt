                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-12">
                            ...
                            <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-3438px, 0px, 0px); transition: 0.25s; width: 6303px;"><div class="owl-item cloned" style="width: 543px; margin-right: 30px;"><div class="reviews-thumb">
                                ...
                                </div></div><div class="owl-item cloned" style="width: 543px; margin-right: 30px;"><div class="reviews-thumb">
                                    <div class="reviews-info d-flex align-items-center">
                                ...
                                </div></div><div class="owl-item" style="width: 543px; margin-right: 30px;"><div class="reviews-thumb">
                                ...
                                </div></div><div class="owl-item active" style="width: 543px; margin-right: 30px;"><div class="reviews-thumb">
                                    <div class="reviews-info d-flex align-items-center">
                                        <img src="images/avatar/blond-man-happy-expression.jpg" class="avatar-image img-fluid" alt="">
