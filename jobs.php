...
include 'includes/site-header-u.php';
                ...
                <?php while ($job = mysqli_fetch_assoc($result)): ?>
                    <div class="job-thumb d-flex">
                        <div class="job-image-wrap bg-white shadow-lg">
                            <img src="<?= $job['company_logo'] ?>" class="job-image img-fluid" alt="<?= $job['job_id'] ?>">
                        </div>
                        <div class="job-body d-flex flex-wrap flex-auto align-items-center ms-4">
                            <div class="mb-3">
                                <h5 class="job-title mb-lg-0">
                                    <span class="editable-field" data-field="title" data-id="<?= $job['job_id'] ?>">
                                        <?= $job['title'] ?>
                                    </span>
                                </h5>
                                <h5 class="job-title mb-lg-0">
                                    <span class="editable-field" data-field="full_name" data-id="<?= $job['job_id'] ?>">
                                        <?= $job['full_name'] ?>
                                    </span>
                                </h5>
                                <div class="d-flex flex-wrap align-items-center">
                                    ...
                                    <p class="job-price mb-0">
                                        ...
                                        $<span class="editable-field" data-field="company_name" data-id="<?= $job['job_id'] ?>">
                                            <?= $job['company_name'] ?>
                                        </span>
                                    </p>
                                </div>
...
<?php include 'includes/footerbanner.php'; ?>
